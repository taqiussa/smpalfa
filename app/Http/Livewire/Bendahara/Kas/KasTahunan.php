...
class KasTahunan extends Component
{
    use GetData;
    ...
    {
        return view('livewire.bendahara.kas.kas-tahunan');
    }
    ...
    private function get_list_pemasukan()
    {
        ...
        $this->total_pembayaran = Pembayaran::where('tahun', $this->tahun)->sum('jumlah');
        $this->total_pemasukan = Pemasukan::where('tahun', $this->tahun)->sum('jumlah') + $this->total_pembayaran;
    }
    private function get_list_pengeluaran()
    {
        ...
        $this->total_pengeluaran = Pengeluaran::where('tahun', $this->tahun)->sum('jumlah');
    }
}
