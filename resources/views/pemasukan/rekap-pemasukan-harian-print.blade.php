...
<body>
    ...
    <div style="text-align: center">
        <h4>LAPORAN HARIAN PEMASUKAN SEKOLAH (VERSI DETAIL)</h4>
    </div>
    <h4>
        Hari, Tanggal : {{ Carbon\Carbon::parse($tanggalawal)->translatedFormat('l, d F Y') }}
        sampai dengan
        {{ Carbon\Carbon::parse($tanggalakhir)->translatedFormat('l, d F Y') }}
    </h4>
    ...
    <table border="1" style="width: 100%;border-collapse:collapse;">
        ...
        <tbody>
            <tr>
                ...
                <td style="padding-left: 5px; text-align:center">{{ Carbon\Carbon::parse($tanggalawal)->translatedFormat('l, d F Y') }}</td>
                <td style="padding-left: 5px; text-align:center">{{ Carbon\Carbon::parse($tanggalakhir)->translatedFormat('l, d F Y') }}</td>
            ...
            <tr>
                <td colspan="4" style="padding-left: 5px"><h3>Total</h3></td>
