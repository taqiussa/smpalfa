...
<ul>
    ...
    <li class="nav-item nav-item-has-children">
        <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu_skor"
            aria-controls="menu_skor" aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
                <svg style="width:22px;height:22px" viewBox="0 0 22 22">
        ...
        <ul id="menu_skor" class="{{ Request::routeIs('admin.skor.*') ? '' : 'collapse' }} dropdown-nav">
            <li>
                <a href="{{ route('admin.skor.data-skor') }}"
                    class="{{ Request::routeIs('admin.user.data-skor') ? 'active' : '' }}">Data Skor</a>
            </li>
        </ul>
    </li>
    <li class="nav-item nav-item-has-children">
