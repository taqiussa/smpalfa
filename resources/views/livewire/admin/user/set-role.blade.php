            ...
            <div class="col-md-6">
                <div class="card shadow rounded-md border-top-0 border-end-0 border-bottom-0 border-primary border-3">
                    <div class="card-body">
                        ...
                        @endforeach
                        <div>
                            <button wire:click.prevent="set_role" class="btn btn-primary mx-1" wire:loading.class="disabled" wire:target="set_role">Simpan <i wire:loading wire:target="set_role" class="fas fa-spin fa-spinner"></i></button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a wire:click.prevent="show_user_roles({{ $user->id }})" role="button"
                                                class="btn btn-primary" wire:loading.class="disabled" wire:target="show_user_roles">Set
                                                Role <i wire:loading wire:target="show_user_roles" class="fas fa-spin fa-spinner"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
